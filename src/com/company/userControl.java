        ...
        if (source.equals(destination)) {
            ...
            try {
               ...
               /* System.out.println("enter the email you wont to use in this trip");
                ...
                ps.setString(2, u.Source);
                ps.setString(3, u.Destination);
                ps.executeUpdate();
    ...
    public String[] Show_Offer(String email1) {
        ...
        try {
            ...
            if (!RS.next()) {
                ...
                u.Source = RS.getString("Source");
                u.Destination = RS.getString("Destination");
                String[]  arr={/*0*/id,/*1*/email1,/*2*/u.Source,/*3*/u.Destination,/*4*/id_user,/*5*/date, /*6*/String.valueOf(Price)};
                ...
                if (!Result.next()) {
                    ...
                    if (Choice == 1) {
                        ...
                        try {
                            ...
                            String query = "delete from Offers where Source= '"+ u.Source +"' and Destination= '"+u.Destination+ "' and User='"+email1+"';";
                        ...
                        try {
                            ...
                            Stmt = connection.createStatement();
                            String query = "delete from onhold_trips where Source= '"+ u.Source +"' and Destination= '"+u.Destination+ "' and User='"+email1+"';";
                            ps = connection.prepareStatement(query);
                            ps.executeUpdate();
                        ...
                        try {
                            ...
                            Stmt = connection.createStatement();
                            String query = "delete from Offers where Source= '"+ u.Source +"' and Destination= '"+u.Destination+ "'";
                            ps = connection.prepareStatement(query);
                            ps.executeUpdate();
