...
import com.company.Transportation_Application.dao.Driver;
...
public class DriverControl {
    ...
    public void  setDriving_license(String drivinglicense){
        driver.Driving_license =drivinglicense;
    }
    ...
    public String setDriving_license(){
        return driver.Driving_license ;
    }

    //Methods
    @PostMapping("service/DriverControl/Register")
    public String Register(@JsonProperty String userName, @JsonProperty String mobileNum,
                           ...
                           @JsonProperty String nationalID,@JsonProperty String drivingLicence) {
    ...
    @GetMapping(path="{driver_national}" )
    public void find_request(@PathVariable("driver_national") String national){
        try {
    ...
    @GetMapping("service/Driver/offer_sharetrip")
    void offer_sharetrip(@JsonProperty String source,@JsonProperty String destination,
                         @JsonProperty String User_ID,@JsonProperty String sharetrip,@JsonProperty int price1) {
        try {
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/transportation",
                    "root", "");
            Statement stmt = connection.createStatement();
    ...
    @PostMapping("service/Driver/Offer")
    int Offer(@JsonProperty String source,@JsonProperty String destination,
              @JsonProperty String User_ID,@JsonProperty String sharetrip,@JsonProperty int price2) {
        ...
        try {
            ...
            ps.setString(1, driver.National_ID);
    ...
    @GetMapping("service/Driver/getNationIDByEmail")
    ...
    @PostMapping("service/DriverControl/Put_FaviorateSource_Areas")
    void Put_FaviorateSource_Areas(@JsonProperty String National_ID,@JsonProperty String Location){
        try{
            // Class.forName("com.mysql.jdbc.Driver");
            Connection con= DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/transportation","root","");
